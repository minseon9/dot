...
**Find previous story:**
- [ ] Load {epics_file} to understand story order
- [ ] Identify previous story in same epic (story_num - 1) or previous epic's last story
- [ ] Check if previous story file exists
- [ ] Check previous story status if file exists
...
- [ ] Priority field present (P0/P1/P2/P3) → If missing → **MINOR ISSUE**
- [ ] Milestone field present (can be empty) → If missing → **MINOR ISSUE**
